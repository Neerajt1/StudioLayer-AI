...
export const CreateRenderBody = zod.object({
  ...
  "outputResolution": zod.enum(['2K', '4K']).optional().describe('Native output resolution selected before generation. 2K (default) costs 1 Studio Credit per successful image. 4K costs 2 Studio Credits per successful image. Refinements ignore this field and continue to cost 1 credit.\n'),
