...
export function buildHeadlessStage1PromptBase(
  ...
  return [
    ...
    "Reference Image 1 = GARMENT — authoritative only for the submitted garment: silhouette/construction, colour, material/fabric, texture, print/embroidery/graphics, seams/details, collars/cuffs/closures, proportions, and visible garment features. Not a person.",
    "Ignore the garment photograph's background, walls, racks, hangers, other garments, floor, props, retail fixtures, room, photographic lighting, and scene shadows — do not reproduce or transfer them.",
    "Reference Image 2 = POSE MASTER — body pose, limb placement, gesture, and pose-related framing ONLY. Faceless geometry. Not identity. Do not import its background, lighting, or unrelated visual styling.",
    furnitureClause,
    ...
    "Render the body, garment, hands, arms, legs, and proportions to full editorial quality. Do not invent a room, lifestyle setting, environmental styling, or environmental lighting scheme.",
    "",
    "BACKGROUND:",
    "Use a clean, neutral pure-white professional studio background — visually white, not grey, cream, beige, warm, cool, tinted, textured, patterned, architectural, retail, lifestyle, or environmental.",
    "Do not introduce windows, window reflections, window-shaped light patterns, walls, panels, racks, rooms, textured floors, rugs, tiles, wood, scenery, or other environmental elements.",
    "Only natural subject grounding/contact shadow is allowed where necessary for realism. Do not create directional environmental light patterns on the background or ground.",
    "",
    "HEAD REGION:",
